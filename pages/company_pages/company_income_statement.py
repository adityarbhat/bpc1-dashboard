...
def get_sample_revenue_data():
    """Return sample revenue data for different companies"""
    return {
        'ACE': {'2020': 12500000, '2021': 14200000, '2022': 16800000, '2023': 15400000, '2024': 17200000},
        'Ace': {'2020': 12500000, '2021': 14200000, '2022': 16800000, '2023': 15400000, '2024': 17200000},
        'A1': {'2020': 18200000, '2021': 19800000, '2022': 21500000, '2023': 20200000, '2024': 22100000},
        'A-1': {'2020': 18200000, '2021': 19800000, '2022': 21500000, '2023': 20200000, '2024': 22100000},
        'ATL': {'2020': 25800000, '2021': 27500000, '2022': 29200000, '2023': 26800000, '2024': 30400000},
        'COR': {'2020': 20100000, '2021': 22300000, '2022': 24800000, '2023': 23100000, '2024': 26500000},
        'EXP': {'2020': 16800000, '2021': 18900000, '2022': 20500000, '2023': 19200000, '2024': 21800000},
        'DEFAULT': {'2020': 15000000, '2021': 16500000, '2022': 18200000, '2023': 17100000, '2024': 19500000}
    }
...
def get_sample_npm_for_company(company_name, year):
    """Return company-specific Net Profit Margin sample data"""
    npm_data = {
        'ACE': {'2020': 4.2, '2021': 2.1, '2022': 2.8, '2023': 1.9, '2024': 2.5},
        'Ace': {'2020': 4.2, '2021': 2.1, '2022': 2.8, '2023': 1.9, '2024': 2.5},
        'A1': {'2020': 3.8, '2021': 5.2, '2022': 4.1, '2023': 2.7, '2024': 3.9},
        'A-1': {'2020': 3.8, '2021': 5.2, '2022': 4.1, '2023': 2.7, '2024': 3.9},
        'ATL': {'2020': 6.1, '2021': 4.8, '2022': 5.5, '2023': 3.2, '2024': 4.7},
        'COR': {'2020': 2.9, '2021': 1.8, '2022': 3.4, '2023': 2.1, '2024': 3.8},
        'EXP': {'2020': 5.3, '2021': 3.6, '2022': 4.9, '2023': 2.8, '2024': 4.2},
        'DEFAULT': {'2020': 4.2, '2021': 2.1, '2022': 2.8, '2023': 1.9, '2024': 2.5}
    }
    
    company_data = npm_data.get(company_name, npm_data['DEFAULT'])
    return company_data.get(year, 0)


def get_sample_gpm_for_company(company_name, year):
    """Return company-specific Gross Profit Margin sample data"""
    gpm_data = {
        'ACE': {'2020': 31.2, '2021': 28.5, '2022': 29.8, '2023': 27.3, '2024': 31.2},
        'Ace': {'2020': 31.2, '2021': 28.5, '2022': 29.8, '2023': 27.3, '2024': 31.2},
        'A1': {'2020': 33.5, '2021': 30.8, '2022': 32.1, '2023': 29.6, '2024': 33.8},
        'A-1': {'2020': 33.5, '2021': 30.8, '2022': 32.1, '2023': 29.6, '2024': 33.8},
        'ATL': {'2020': 35.2, '2021': 32.4, '2022': 34.7, '2023': 31.9, '2024': 36.1},
        'COR': {'2020': 29.8, '2021': 26.9, '2022': 28.5, '2023': 25.7, '2024': 30.3},
        'EXP': {'2020': 32.1, '2021': 29.3, '2022': 31.2, '2023': 28.4, '2024': 32.9},
        'DEFAULT': {'2020': 31.2, '2021': 28.5, '2022': 29.8, '2023': 27.3, '2024': 31.2}
    }
    
    company_data = gpm_data.get(company_name, gpm_data['DEFAULT'])
    return company_data.get(year, 0)


def get_sample_opm_for_company(company_name, year):
    """Return company-specific Operating Profit Margin sample data"""
    opm_data = {
        'ACE': {'2020': 5.8, '2021': 3.2, '2022': 4.1, '2023': 2.9, '2024': 3.8},
        'Ace': {'2020': 5.8, '2021': 3.2, '2022': 4.1, '2023': 2.9, '2024': 3.8},
        'A1': {'2020': 6.5, '2021': 4.8, '2022': 5.2, '2023': 3.7, '2024': 4.9},
        'A-1': {'2020': 6.5, '2021': 4.8, '2022': 5.2, '2023': 3.7, '2024': 4.9},
        'ATL': {'2020': 7.2, '2021': 5.9, '2022': 6.8, '2023': 4.5, '2024': 6.1},
        'COR': {'2020': 4.9, '2021': 2.8, '2022': 3.6, '2023': 2.1, '2024': 3.2},
        'EXP': {'2020': 6.1, '2021': 4.2, '2022': 5.5, '2023': 3.8, '2024': 4.7},
        'DEFAULT': {'2020': 5.8, '2021': 3.2, '2022': 4.1, '2023': 2.9, '2024': 3.8}
    }
    
    company_data = opm_data.get(company_name, opm_data['DEFAULT'])
    return company_data.get(year, 0)


def get_sample_income_statement_dollars_for_company(company_name, year):
    """Return company-specific Income Statement dollar amounts sample data"""
    # Sample data for different companies with realistic financial relationships
    income_statement_data = {
        'ACE': {
            '2020': {'total_revenue': 12500000, 'total_cogs': 8600000, 'operating_expense': 3175000, 'operating_profit': 725000, 'profit_before_tax': 525000},
            '2021': {'total_revenue': 14200000, 'total_cogs': 10146000, 'operating_expense': 3744000, 'operating_profit': 310000, 'profit_before_tax': 298000},
            '2022': {'total_revenue': 16800000, 'total_cogs': 11792000, 'operating_expense': 4368000, 'operating_profit': 640000, 'profit_before_tax': 470000},
            '2023': {'total_revenue': 15400000, 'total_cogs': 11196000, 'operating_expense': 3850000, 'operating_profit': 354000, 'profit_before_tax': 293000},
            '2024': {'total_revenue': 17200000, 'total_cogs': 11836000, 'operating_expense': 4730000, 'operating_profit': 634000, 'profit_before_tax': 430000}
        },
        'Ace': {
            '2020': {'total_revenue': 12500000, 'total_cogs': 8600000, 'operating_expense': 3175000, 'operating_profit': 725000, 'profit_before_tax': 525000},
            '2021': {'total_revenue': 14200000, 'total_cogs': 10146000, 'operating_expense': 3744000, 'operating_profit': 310000, 'profit_before_tax': 298000},
        ...
        'A1': {
            '2020': {'total_revenue': 18200000, 'total_cogs': 12094000, 'operating_expense': 4914000, 'operating_profit': 1192000, 'profit_before_tax': 692000},
            '2021': {'total_revenue': 19800000, 'total_cogs': 13702000, 'operating_expense': 5346000, 'operating_profit': 752000, 'profit_before_tax': 1030000},
            '2022': {'total_revenue': 21500000, 'total_cogs': 14535000, 'operating_expense': 5806000, 'operating_profit': 1159000, 'profit_before_tax': 882000},
            '2023': {'total_revenue': 20200000, 'total_cogs': 14222000, 'operating_expense': 5326000, 'operating_profit': 652000, 'profit_before_tax': 545000},
            '2024': {'total_revenue': 22100000, 'total_cogs': 14626000, 'operating_expense': 6379000, 'operating_profit': 1095000, 'profit_before_tax': 862000}
        },
        'A-1': {
            '2020': {'total_revenue': 18200000, 'total_cogs': 12094000, 'operating_expense': 4914000, 'operating_profit': 1192000, 'profit_before_tax': 692000},
            '2021': {'total_revenue': 19800000, 'total_cogs': 13702000, 'operating_expense': 5346000, 'operating_profit': 752000, 'profit_before_tax': 1030000},
        ...
        'ATL': {
            '2020': {'total_revenue': 25800000, 'total_cogs': 14922000, 'operating_expense': 8418000, 'operating_profit': 2460000, 'profit_before_tax': 1574000},
            '2021': {'total_revenue': 27500000, 'total_cogs': 18562500, 'operating_expense': 7150000, 'operating_profit': 1787500, 'profit_before_tax': 1320000},
            '2022': {'total_revenue': 29200000, 'total_cogs': 19058000, 'operating_expense': 8322000, 'operating_profit': 1820000, 'profit_before_tax': 1606000},
            '2023': {'total_revenue': 26800000, 'total_cogs': 18246000, 'operating_expense': 7342000, 'operating_profit': 1212000, 'profit_before_tax': 858000},
            '2024': {'total_revenue': 30400000, 'total_cogs': 19456000, 'operating_expense': 9234000, 'operating_profit': 1710000, 'profit_before_tax': 1429000}
        },
        'COR': {
            '2020': {'total_revenue': 20100000, 'total_cogs': 14110200, 'operating_expense': 5125000, 'operating_profit': 864800, 'profit_before_tax': 583000},
            '2021': {'total_revenue': 22300000, 'total_cogs': 16287900, 'operating_expense': 5610000, 'operating_profit': 402100, 'profit_before_tax': 401000},
            '2022': {'total_revenue': 24800000, 'total_cogs': 17732000, 'operating_expense': 6076000, 'operating_profit': 992000, 'profit_before_tax': 843000},
            '2023': {'total_revenue': 23100000, 'total_cogs': 17157300, 'operating_expense': 5458000, 'operating_profit': 484700, 'profit_before_tax': 485000},
            '2024': {'total_revenue': 26500000, 'total_cogs': 18465500, 'operating_expense': 7212000, 'operating_profit': 822500, 'profit_before_tax': 1007000}
        },
        'EXP': {
            '2020': {'total_revenue': 16800000, 'total_cogs': 11407200, 'operating_expense': 4284000, 'operating_profit': 1108800, 'profit_before_tax': 890000},
            '2021': {'total_revenue': 18900000, 'total_cogs': 13362300, 'operating_expense': 4725000, 'operating_profit': 812700, 'profit_before_tax': 680000},
            '2022': {'total_revenue': 20500000, 'total_cogs': 14104000, 'operating_expense': 5330000, 'operating_profit': 1066000, 'profit_before_tax': 1005000},
            '2023': {'total_revenue': 19200000, 'total_cogs': 13737600, 'operating_expense': 4800000, 'operating_profit': 662400, 'profit_before_tax': 538000},
            '2024': {'total_revenue': 21800000, 'total_cogs': 14627800, 'operating_expense': 5886000, 'operating_profit': 1286200, 'profit_before_tax': 916000}
        },
        'DEFAULT': {
            '2020': {'total_revenue': 15000000, 'total_cogs': 10312500, 'operating_expense': 3825000, 'operating_profit': 862500, 'profit_before_tax': 630000},
            '2021': {'total_revenue': 16500000, 'total_cogs': 11797500, 'operating_expense': 4125000, 'operating_profit': 577500, 'profit_before_tax': 347000},
            '2022': {'total_revenue': 18200000, 'total_cogs': 12776000, 'operating_expense': 4732000, 'operating_profit': 692000, 'profit_before_tax': 510000},
            '2023': {'total_revenue': 17100000, 'total_cogs': 12438300, 'operating_expense': 4275000, 'operating_profit': 386700, 'profit_before_tax': 325000},
            '2024': {'total_revenue': 19500000, 'total_cogs': 13417500, 'operating_expense': 5265000, 'operating_profit': 817500, 'profit_before_tax': 488000}
        }
    }
    
    company_data = income_statement_data.get(company_name, income_statement_data['DEFAULT'])
    return company_data.get(year, income_statement_data['DEFAULT']['2020'])
