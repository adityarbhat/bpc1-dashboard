...
class AirtableIncomeStatementUploader:
    ...
    def get_existing_income_statement_record(self, period_id, company_id):
    ...
    def upload_income_statement(self, period_id, financial_data, data_source, company_id, user_email=None, publication_status='submitted'):
        """
        ...
        existing_record = self.get_existing_income_statement_record(period_id, company_id)
